<div class="container">
  <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
    <div class="col-md-4 d-flex">
      ...
      <span class="mb-3 mb-md-0 text-body-secondary">&copy Copyright by An</span>
    </div>
    ...
    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      ...
      <li class="ms-3">
        <a class="text-body-secondary" href="https://www.facebook.com/">
        <svg xmlns="https://www.facebook.com/" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
